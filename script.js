...
let labelPontuacao = 0;
let pontuacaoFinal = labelPontuacao;
...
function pararJogoEMostrarBombas(campo, localBombas){
    ...
    setInterval(function(){
        if(i < localBombas.length) {
            ...
            if (i == localBombas.length) {
                mostrarMensagem(document.getElementById("btnVoltar"), text.perdeu)
                pontuacaoFinal = labelPontuacao;
                labelPontuacao = 0;
                aumentarPontuacao()
            }
        }
...
function voltarParaTelaInicial() {
    ...
    $(document).ready(function () {
        ...
        dataType: 'json',
        data: {points: pontuacaoFinal, time: tempoDeJogo},
...
function aumentarPontuacao() {
    labelPontuacao++;
    document.getElementById("labelPontuacao").innerText =  labelPontuacao;
}